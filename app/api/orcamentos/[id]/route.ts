      ...
      return NextResponse.json({
        ...
        resultado: {
          ambientes: resultadosPapel.map(r => ({
            ...
            custoMaterial: isAdmin ? r.custoTotal : undefined,
          ...
          totalCusto: isAdmin ? resultadosPapel.reduce((s, r) => s + r.custoTotal, 0) : undefined,
          totalComissao: resultadosPapel.reduce((s, r) => s + r.valorComissao, 0),
          totalRt: isAdmin ? resultadosPapel.reduce((s, r) => s + r.valorRt, 0) : undefined,
          totalMargem: isAdmin ? resultadosPapel.reduce((s, r) => s + (r.precoComMarkup - r.custoTotal), 0) : undefined,
          clienteTemArquiteto: false,
        },
      })
    }
    ...
    if (produto === 'persiana' && ambientesPersiana?.length) {
      ...
      return NextResponse.json({
        ...
        resultado: {
          ...
          totalPrecoFinalVenda: totalPrecoFinal,
          totalCusto: isAdmin ? resultadosPersiana.reduce((s, r) => s + r.custoTotal, 0) : undefined,
          totalComissao: resultadosPersiana.reduce((s, r) => s + r.valorComissao, 0),
          totalRt: isAdmin ? resultadosPersiana.reduce((s, r) => s + r.valorRt, 0) : undefined,
          totalMargem: isAdmin ? resultadosPersiana.reduce((s, r) => s + r.margem, 0) : undefined,
          comissaoVendedor,
          clienteTemArquiteto,
        },
      })
      ...
      return NextResponse.json({
        ...
        resultado: {
          ambientes: resultados.map(r => ({
            ...
            custoManta: isAdmin ? r.custoManta : undefined,
            custoRodape: isAdmin ? r.custoRodape : undefined,
            custoPerfis: isAdmin ? r.custoPerfis : undefined,
            custoPrego: isAdmin ? r.custoPrego : undefined,
            custoCola: isAdmin ? r.custoCola : undefined,
            custoMassa: isAdmin ? r.custoMassa : undefined,
            custoAcabamentos: isAdmin ? r.custoAcabamentos : undefined,
            custoOutros: isAdmin ? r.custoOutros : undefined,
