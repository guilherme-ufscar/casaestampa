      ...
      <Page size="A4" style={s.page}>
        <View style={s.header}>
          ...
          <View style={s.headerRight}>
            <Text style={s.titulo}>Relatório Executivo</Text>
            <Text style={s.meta}>Período: {props.periodo}</Text>
        ...
        <View style={s.kpiRow}>
          ...
          <View style={s.kpiBox}><Text style={s.kpiLabel}>Orçamentos</Text><Text style={s.kpiValue}>{props.totalOrcamentos}</Text></View>
          <View style={s.kpiBox}><Text style={s.kpiLabel}>Fechados</Text><Text style={s.kpiValue}>{props.fechados}</Text></View>
          <View style={s.kpiBox}><Text style={s.kpiLabel}>Conversão</Text><Text style={s.kpiValue}>{props.conversao}%</Text></View>
        </View>
        ...
        <View style={s.tableHeader}>
          ...
          <Text style={{ width: '13%', fontSize: 7, fontWeight: 600, color: MUTED, textTransform: 'uppercase', textAlign: 'center' }}>Orçamentos</Text>
          ...
          <Text style={{ width: '19%', fontSize: 7, fontWeight: 600, color: MUTED, textTransform: 'uppercase', textAlign: 'right' }}>Comissão</Text>
        </View>
        ...
        <Text style={[s.sectionTitle, { marginTop: 20 }]}>Orçamentos do Período</Text>
        <View style={s.sectionLine} />
        <View style={s.tableHeader}>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footerText}>Casa Estampa Interiores{props.telefoneEmpresa ? ` · ${props.telefoneEmpresa}` : ''}</Text>
          <Text style={[s.footerText, { marginTop: 2 }]}>Relatório gerado em {dataGeracao}</Text>
        </View>
      </Page>
    </Document>
  )
